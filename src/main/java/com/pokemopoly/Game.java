...
public class Game {
    ...
    public void setUpBoard() {
        List<Tile> tiles = new ArrayList<>(Arrays.asList(
                ...
                new EventTile("Event Tile", 2, root, v -> nextTurnCallback.run() , deckManager.drawEvent()),
                ...
                new EventTile("Event Tile", 22, root, v -> nextTurnCallback.run(), deckManager.drawEvent()),
