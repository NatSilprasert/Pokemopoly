...
public class EventTile extends Tile {
    ...
    private final EventCard deck;

    public EventTile(String name, int index, StackPane rootPane, Consumer<Void> endTurnCallback, EventCard deck) {
        super(name, index);
    ...
    public void onLand(Player player, Game game) {
        ...
        System.out.println(player.getName() + " landed on Event Tile!");
